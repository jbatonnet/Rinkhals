...
#   docker run --rm -it -e KOBRA_MODEL_CODE="K3" -v .\build:/build -v .\files:/files ghcr.io/jbatonnet/rinkhals/build /build/swu-tools/catch-update/build-swu.sh
...
cp /build/swu-tools/catch-update/update.sh /tmp/update_swu/update.sh
