...
/ac_lib/lib/third_bin/ffmpeg -i /tmp/framebuffer.bmp -i $RINKHALS_ROOT/usr/share/data/icon.bmp -filter_complex "[0:v][1:v] overlay=208:104" -pix_fmt bgra -f fbdev /dev/fb0 1>/dev/null 2>/dev/null
