...
class RinkhalsInstallApp(BaseApp):
    ...
    def show_diagnostic_modal(self, diagnostic: Diagnostic):
        ...
        if diagnostic.fix == DiagnosticFixes.RESET_CONFIGURATION:
        ...
        elif diagnostic.fix == DiagnosticFixes.REINSTALL_RINKHALS:
        ...
        elif diagnostic.fix == DiagnosticFixes.REINSTALL_FIRMWARE:
        ...
        def download_version():
            ...
            try:
                ...
                with requests.get(version.url, stream=True) as r:
                    r.raise_for_status()
                    with open(target_path, 'wb') as f:
                        total_length = int(r.headers.get('content-length', 150 * 1024 * 1024))
                        downloaded = 0
                        last_update_time = 0
