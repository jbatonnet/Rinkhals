...
class style_transition_dsc:
    ...
    def init(self, props: 'lv_style_prop_t', path_cb: 'lv_anim_path_cb_t', time: 'int', delay: 'int', user_data: 'str') -> 'None':
...
class rb:
    ...
    def init(self, compare: 'lv_rb_compare_t', node_size: 'size_t') -> 'bool':
        ...
        if isinstance(compare, ffi.CData):
            compare_wrapper = compare
        else:
            compare_wrapper = self._callbacks.get(compare)
...
class draw_buf_handlers:
    ...
    def init(self, buf_malloc_cb: 'lv_draw_buf_malloc_cb', buf_free_cb: 'lv_draw_buf_free_cb', align_pointer_cb: 'lv_draw_buf_align_cb', invalidate_cache_cb: 'lv_draw_buf_cache_operation_cb', flush_cache_cb: 'lv_draw_buf_cache_operation_cb', width_to_stride_cb: 'lv_draw_buf_width_to_stride_cb') -> 'None':
        ...
        if isinstance(buf_malloc_cb, ffi.CData):
            buf_malloc_cb_wrapper = buf_malloc_cb
        else:
            buf_malloc_cb_wrapper = self._callbacks.get(buf_malloc_cb)
        if not buf_malloc_cb_wrapper:
        ...
        if isinstance(buf_free_cb, ffi.CData):
            buf_free_cb_wrapper = buf_free_cb
        else:
            buf_free_cb_wrapper = self._callbacks.get(buf_free_cb)
        if not buf_free_cb_wrapper:
        ...
        if isinstance(align_pointer_cb, ffi.CData):
            align_pointer_cb_wrapper = align_pointer_cb
        else:
            align_pointer_cb_wrapper = self._callbacks.get(align_pointer_cb)
        if not align_pointer_cb_wrapper:
        ...
        if isinstance(invalidate_cache_cb, ffi.CData):
            invalidate_cache_cb_wrapper = invalidate_cache_cb
        else:
            invalidate_cache_cb_wrapper = self._callbacks.get(invalidate_cache_cb)
        if not invalidate_cache_cb_wrapper:
        ...
        if isinstance(flush_cache_cb, ffi.CData):
            flush_cache_cb_wrapper = flush_cache_cb
        else:
            flush_cache_cb_wrapper = self._callbacks.get(flush_cache_cb)
        if not flush_cache_cb_wrapper:
        ...
        if isinstance(width_to_stride_cb, ffi.CData):
            width_to_stride_cb_wrapper = width_to_stride_cb
        else:
            width_to_stride_cb_wrapper = self._callbacks.get(width_to_stride_cb)
        if not width_to_stride_cb_wrapper:
