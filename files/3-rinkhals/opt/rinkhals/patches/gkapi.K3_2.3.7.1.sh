...
# Before MD5: bd8c035bfa0eb867281914b3040b5480
# After MD5: 7c6f580b426bd95dbb91cc12eb8de71b

TARGET=$1

MD5=$(md5sum $TARGET | awk '{print $1}')
if [ "$MD5" = "7c6f580b426bd95dbb91cc12eb8de71b" ]; then
    echo $TARGET is already patched, skipping...
    exit 0
fi
if [ "$MD5" != "bd8c035bfa0eb867281914b3040b5480" ]; then
