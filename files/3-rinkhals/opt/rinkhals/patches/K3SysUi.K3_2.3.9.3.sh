...
# After MD5: ec6a6544613376810eca2b5057cf6214

TARGET=$1

MD5=$(md5sum $TARGET | awk '{print $1}')
if [ "$MD5" = "ec6a6544613376810eca2b5057cf6214" ]; then
...
dd if=$PATCH_FILE skip=330 ibs=1 of=$TARGET seek=976028 obs=1 count=12 conv=notrunc # 0xee49c / 0xfe49c > 0x0410a0e30af4feebd0fbffea
dd if=$PATCH_FILE skip=342 ibs=1 of=$TARGET seek=2794140 obs=1 count=16 conv=notrunc # 0x2aa29c / 0x2ba29c > 0x52696e6b68616c730052696e6b68616c
